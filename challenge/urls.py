...
urlpatterns = [
    ...
    url(r'^administration/historique/$', views.historiqueView, name='historique'),
    url(r'^administration/verifieCodes/$', views.administrationView, name='administrationVerifCodes'),
